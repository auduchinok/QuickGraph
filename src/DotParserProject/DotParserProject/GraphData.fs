...
type GraphData = class
    ...
    val mutable public graph : IMutableVertexAndEdgeSet<string * Dictionary<string, string>, SEdge<string * Dictionary<string, string>>>
    ...
    member x.AddNode name attributes =
        x.graph.AddVertex
